...
public class ItemsController {
    ...
    * */
    ...
    public Result queryItemsUp(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                               @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date iDate,
        ...
        Integer pageSize = 5;/*设置每页多少条页数*/
        PageHelper.startPage(pageNum,pageSize);
        PageInfo<ItemsVo> pageInfo = new PageInfo<>(itemsService.selectItemsUp(caFather, iName, caId, type));
    ...
    * */
    ...
    public Result queryItemsDown(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                                 @RequestParam(value = "caFather", defaultValue = "") String caFather,
                                 @RequestParam(value = "iName", defaultValue = "") String iName,
                                 @RequestParam(value = "caId", defaultValue = "") String caId,
                                 @RequestParam(value = "type", defaultValue = "i_id") String type) throws Exception {
        ...
        Integer pageSize = 5;/*设置每页多少条页数*/
        PageHelper.startPage(pageNum,pageSize);
        PageInfo<ItemsVo> pageInfo = new PageInfo<>(itemsService.selectItemsDown(caFather, iName, caId, type));
        return ResultUtil.success(pageInfo);
    }
    ...
    * */
    ...
    public Result queryItemsSearch(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                                   @RequestParam(value = "search", defaultValue = "") String search) {
      /*  search = request.getParameter("search");*/
        System.out.println(search + "-------");
        Integer pageSize=5;
        PageHelper.startPage(pageNum,pageSize);
        PageInfo<ItemsVo> pageInfo = new PageInfo<>(itemsService.selectItemsAll(search));
        return ResultUtil.success(pageInfo);
    }
